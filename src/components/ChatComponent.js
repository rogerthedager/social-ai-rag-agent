...
const ChatComponent = (props) => {
  ...
  const { 
    transcript,
    listening,// ai state to listen the speech
    resetTranscript,
    browserSupportsSpeechRecognition, // check the broswer is support the funciton or not 
    isMicrophoneAvailable,//check the microphone is open or not
  } = useSpeechRecognition();
